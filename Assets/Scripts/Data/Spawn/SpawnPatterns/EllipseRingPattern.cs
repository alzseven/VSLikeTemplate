...
{
    [CreateAssetMenu(fileName = "EllipseRingPattern", menuName = "Data/Spawn/SpawnPatterns/EllipseRing", order = 1)]
    public class EllipseRingPattern : SpawnPattern
    {
            ...
            Vector2 centerPos)
        {
            ...
            for (var pointNum = 0; pointNum < spawnCount; pointNum++)
            {
                ...
                var x = Mathf.Sin(angle) * spawnRange;
                var y = Mathf.Cos(angle) * spawnRange * 2f;
